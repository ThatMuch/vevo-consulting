...
function stanlee_register_required_plugins()
{
	...
	$plugins = array(
		...
		array(
			...
			'version'            => '5.9.4',                                                                    // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'version'            => '5.9.4',                                                                    // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
		),
		array(
		...
		array(
			'name'     => 'Convert ACF PHP to JSON',                                       // The plugin name.
			'slug'     => 'acf-php-to-json',                                               // The plugin slug (typically the folder name).
			'source'   => get_template_directory() . '/inc/plugins/acf-php-to-json.zip',   // The plugin source.
			'required' => false,                                                           // If false, the plugin is only 'recommended' instead of required.
		),
		array(
			'name'     => 'FakerPress',
